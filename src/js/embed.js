...
const createArticle = (data) => {
    ...
    article.className = 'bg-white border-solid border-2 border-orange hover:border-darkBlue hover:-rotate-2 transition ease-in-out delay-75 rounded-2xl p-4 flex max-w-xl flex-col items-start justify-between overflow-hidden break-words';
    ...
    titleElement.className = 'mt-5 line-clamp-3 text-sm leading-6 text-gray-600 w-full truncate';
